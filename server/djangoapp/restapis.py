...
def post_request(url, json_payload, **kwargs):
    ...
    url =  "https://promeissa1-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
...
def analyze_review_sentiments(text):
    url = "https://api.eu-de.natural-language-understanding.watson.cloud.ibm.com/instances/022fdcd5-06fc-46fa-ad58-b5352f13274e"
    api_key = "PNkWYanJJheSMuCDL0KLy0r5CRwEcmrcVbZxfZFK0wMD"
